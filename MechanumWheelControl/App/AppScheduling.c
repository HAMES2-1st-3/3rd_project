...
static void AppTask20ms(void)
{
    //observer=observer_theta_fl(0.02);
    //theta_tilde_observer=observer.theta_tilde;
...
static void AppTask50ms(void)
{
    ...
    _usb_printf("g_ref_rpm.fl:%lf,g_cur_rpm.fr:%lf\n",g_ref_rpm.fl,g_cur_rpm.fr);
